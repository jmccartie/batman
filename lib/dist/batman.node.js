...
(function() {
  ...
  Batman.EventEmitter = {
    ...
    event: function(key, createEvent) {
      var ancestor, eventClass, events, existingEvent, newEvent, _base, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5;
      if (createEvent == null) {
        createEvent = true;
      }
      Batman.initializeObject(this);
      if ((_ref = this._batman.events) != null ? _ref.hasOwnProperty(key) : void 0) {
        return this._batman.events[key];
      } else {
        existingEvent = (_ref1 = this._ancestorEvents) != null ? _ref1[key] : void 0;
        if (!existingEvent) {
          _ref2 = this._batman.ancestors();
          for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
            ancestor = _ref2[_i];
            if (existingEvent = (_ref3 = ancestor._batman) != null ? (_ref4 = _ref3.events) != null ? _ref4[key] : void 0 : void 0) {
              this._ancestorEvents || (this._ancestorEvents = {});
              this._ancestorEvents[key] = existingEvent;
              break;
            }
          }
        }
        if (createEvent || (existingEvent != null ? existingEvent.oneShot : void 0)) {
          ...
          if ((_ref5 = this._ancestorEvents) != null) {
            _ref5[key] = void 0;
          }
...
(function() {
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.event = function(key, createEvent) {
      var ancestor, event, eventClass, existingEvent, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
      if (createEvent == null) {
        createEvent = true;
      }
      if (event = (_ref = this.events) != null ? _ref[key] : void 0) {
        return event;
      }
      existingEvent = (_ref1 = this._ancestorEvents) != null ? _ref1[key] : void 0;
      if (((_ref2 = this.base._batman) != null ? _ref2.ancestors() : void 0) && !existingEvent) {
        _ref4 = (_ref3 = this.base._batman) != null ? _ref3.ancestors() : void 0;
        for (_i = 0, _len = _ref4.length; _i < _len; _i++) {
          ancestor = _ref4[_i];
          if (existingEvent = (_ref5 = ancestor._batman) != null ? (_ref6 = _ref5.properties) != null ? (_ref7 = _ref6.get(this.key)) != null ? (_ref8 = _ref7.events) != null ? _ref8[key] : void 0 : void 0 : void 0 : void 0) {
            this._ancestorEvents || (this._ancestorEvents = {});
            this._ancestorEvents[key] = existingEvent;
            break;
          }
      ...
      if (createEvent || (existingEvent != null ? existingEvent.oneShot : void 0)) {
        ...
        if ((_ref9 = this._ancestorEvents) != null) {
          _ref9[key] = void 0;
        }
        this.events[key] = new eventClass(this, key);
        this.events[key].oneShot = existingEvent != null ? existingEvent.oneShot : void 0;
    ...
    Property.prototype.changeEvent = function(createEvent) {
      var event;
      if (createEvent == null) {
        createEvent = true;
      }
      if (event = this.event('change', createEvent)) {
    ...
    Property.prototype.eachObserver = function(iterator) {
      var ancestor, handlers, key, object, property, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3, _results;
      key = this.key;
      handlers = (_ref = this.changeEvent(false)) != null ? (_ref1 = _ref.handlers) != null ? _ref1.slice() : void 0 : void 0;
      if (handlers) {
      ...
      if (this.base.isObservable) {
        ...
        for (_j = 0, _len1 = _ref2.length; _j < _len1; _j++) {
          ...
          if (ancestor.isObservable && ancestor.hasProperty(key)) {
            ...
            handlers = (_ref3 = property.changeEvent(false)) != null ? _ref3.handlers : void 0;
            if (handlers) {
              _results.push((function() {
                var _k, _len2, _ref4, _results1;
                _ref4 = handlers != null ? handlers.slice() : void 0;
                _results1 = [];
    ...
    Property.prototype.fire = function() {
      ...
      args.push(this.key);
      return (_ref = this.changeEvent(false)) != null ? _ref.fireWithContext(this.base, args) : void 0;
    };
