...
(function() {
  ...
  Batman.Property = (function() {
    ...
    Property.prototype.event = function(key, createEvent) {
      var ancestor, ancestors, event, eventClass, existingEvent, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7;
      if (createEvent == null) {
        createEvent = true;
      }
      if (event = (_ref = this.events) != null ? _ref[key] : void 0) {
        ...
        ancestors = (_ref1 = this.base._batman) != null ? _ref1.ancestors() : void 0;
        if (ancestors) {
          _ref3 = (_ref2 = this.base._batman) != null ? _ref2.ancestors() : void 0;
          for (_i = 0, _len = _ref3.length; _i < _len; _i++) {
            ancestor = _ref3[_i];
            existingEvent = (_ref4 = ancestor._batman) != null ? (_ref5 = _ref4.properties) != null ? (_ref6 = _ref5.get(this.key)) != null ? (_ref7 = _ref6.events) != null ? _ref7[key] : void 0 : void 0 : void 0 : void 0;
            if (existingEvent) {
              break;
            }
          }
    ...
    Property.prototype.changeEvent = function(createEvent) {
      ...
      event = this.event('change', createEvent);
      if (event) {
    ...
    Property.prototype.fire = function() {
      var _ref;
      return (_ref = this.changeEvent(false)) != null ? _ref.fireWithContext.apply(_ref, [this.base].concat(__slice.call(arguments), [this.key])) : void 0;
    };
